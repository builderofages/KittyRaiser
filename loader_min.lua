local function M(p,c,n)local e=p:FindFirstChild(n);if e and e.ClassName==c then return e end;if e then e:Destroy() end;local o=Instance.new(c);o.Name=n;o.Parent=p;return o end;local m=M(game.ReplicatedStorage,'Folder','Modules')
M(m,'ModuleScript','GameConfig').Source=[[
local GameConfig = {}
GameConfig.STARTING_CHAOS = 0
GameConfig.STARTING_HELLTOKENS = 0
GameConfig.STARTING_LEVEL = 1
GameConfig.LEVEL_CAP = 100
...
GameConfig.RED_MIST_CHAOS_MULT = 2.0
...
M(m,'ModuleScript','PrankConfig').Source=[[
local PrankConfig = {}
PrankConfig.Pranks = {
    CatScratch = {
        name = "CatScratch",
...
M(m,'ModuleScript','CosmeticConfig').Source=[[
...
M(m,'ModuleScript','PerkConfig').Source=[[
local PerkConfig = {}
PerkConfig.Perks = {
...
M(m,'ModuleScript','RemoteEvents').Source=[[
...
local DEFINITIONS = {
    ...
    EmoteBroadcast = "Event",
    SurvivalUpdate = "Event",
    DailyAvailable = "Event",
}
...
M(game.ServerScriptService,'Script','AnalyticsHandler').Source=[[
...
M(game.ServerScriptService,'Script','AntiCheat').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local GameConfig = require(ReplicatedStorage.Modules.GameConfig)
local AntiCheat = {}
...
M(game.ServerScriptService,'Script','DataHandler').Source=[[
local Players = game:GetService("Players")
...
M(game.ServerScriptService,'Script','SummonSystem').Source=[[
local Players = game:GetService("Players")
...
M(game.ServerScriptService,'Script','PrankSystem').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
M(game.ServerScriptService,'Script','MonetizationHandler').Source=[[
local MarketplaceService = game:GetService("MarketplaceService")
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local DataStoreService = game:GetService("DataStoreService")
...
M(game.ServerScriptService,'Script','RebirthHandler').Source=[[
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local GameConfig = require(ReplicatedStorage.Modules.GameConfig)
local function waitFor(globalName)
...
M(game.ServerScriptService,'Script','CosmeticHandler').Source=[[
local Players = game:GetService("Players")
local MarketplaceService = game:GetService("MarketplaceService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
...
M(game.ServerScriptService,'Script','LeaderboardHandler').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
...
M(game.ServerScriptService,'Script','PerkSystem').Source=[[
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local GameConfig = require(ReplicatedStorage.Modules.GameConfig)
...
Remotes.LevelUp.OnServerEvent:Connect(function() end)
...
M(game.ServerScriptService,'Script','SurvivalSystem').Source=[[
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
...
M(game.ServerScriptService,'Script','WeatherSystem').Source=[[
...
M(game.ServerScriptService,'Script','DailyRewardSystem').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local function waitFor(g) while not _G[g] do task.wait() end return _G[g] end
...
M(game.ServerScriptService,'Script','EmoteSystem').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local GameConfig = require(ReplicatedStorage.Modules.GameConfig)
...
M(game.ServerScriptService,'Script','AdminSystem').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local function waitFor(g) while not _G[g] do task.wait() end return _G[g] end
...
M(game.ServerScriptService,'Script','MapBuilder').Source=[[
local Workspace = game:GetService("Workspace")
local Lighting = game:GetService("Lighting")
...
M(game.StarterGui,'LocalScript','HUDBuilder').Source=[[
local Players = game:GetService("Players")
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','HUDController').Source=[[
local Players = game:GetService("Players")
local TweenService = game:GetService("TweenService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local MarketplaceService = game:GetService("MarketplaceService")
...
if botBar then
    ...
    if rebirthBtn then
        rebirthBtn.MouseButton1Click:Connect(function()
            ...
            if not ok then
                Remotes.NotifyClient:FireClient
            end
        end)
    end
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','InputHandler').Source=[[
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
local UserInputService = game:GetService("UserInputService")
local TweenService = game:GetService("TweenService")
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','EffectsController').Source=[[
local Players = game:GetService("Players")
local TweenService = game:GetService("TweenService")
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','TutorialController').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local player = Players.LocalPlayer
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','PerkUI').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','SurvivalUI').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','EmoteWheel').Source=[[
local Players = game:GetService("Players")
local UserInputService = game:GetService("UserInputService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','DailyRewardUI').Source=[[
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = require(ReplicatedStorage.Modules.RemoteEvents)
local player = Players.LocalPlayer
...
M(game.StarterPlayer:WaitForChild('StarterPlayerScripts'),'LocalScript','WeatherClient').Source=[[
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
local TweenService = game:GetService("TweenService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
print('[KittyRaiser] all scripts loaded')
